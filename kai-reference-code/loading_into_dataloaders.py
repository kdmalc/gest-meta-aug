# This is Kai's original code which loads the dataset into PyTorch dataloaders
## For our project, we don't need to be using dataloaders (for now)
## This code will just serve as a reference for how I was doing things
